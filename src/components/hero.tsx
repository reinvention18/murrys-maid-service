...
export function Hero() {
  ...
  return (
    <section className="relative pt-[130px] max-md:pt-24 max-[480px]:pt-[84px] px-9 max-md:px-[18px] max-[480px]:px-3.5 overflow-hidden min-h-screen max-md:min-h-0 flex flex-col" id="top">
